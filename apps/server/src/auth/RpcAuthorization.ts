...
export const RPC_REQUIRED_SCOPES = {
  ...
  [WS_METHODS.serverStartProviderConnection]: AuthOrchestrationOperateScope,
  [WS_METHODS.serverCancelProviderConnection]: AuthOrchestrationOperateScope,
  [WS_METHODS.serverSubmitProviderAuthorizationCode]: AuthOrchestrationOperateScope,
  [WS_METHODS.serverDisconnectProvider]: AuthOrchestrationOperateScope,
  [WS_METHODS.serverPlanProviderRuntime]: AuthOrchestrationOperateScope,
  [WS_METHODS.serverStartProviderRuntime]: AuthOrchestrationOperateScope,
  [WS_METHODS.serverCancelProviderRuntime]: AuthOrchestrationOperateScope,
  ...
  [WS_METHODS.projectsSubscribeFileChanges]: AuthOrchestrationReadScope,
  [WS_METHODS.projectsSearchContents]: AuthOrchestrationReadScope,
  [WS_METHODS.projectsSearchEntries]: AuthOrchestrationReadScope,
  [WS_METHODS.projectsWriteFile]: AuthOrchestrationOperateScope,
  [WS_METHODS.analysisInspectRuntimes]: AuthOrchestrationReadScope,
  [WS_METHODS.analysisConfigureRuntime]: AuthOrchestrationOperateScope,
  [WS_METHODS.analysisVerifyRuntime]: AuthOrchestrationOperateScope,
  [WS_METHODS.analysisStartRun]: AuthOrchestrationOperateScope,
  [WS_METHODS.analysisCancelRun]: AuthOrchestrationOperateScope,
  [WS_METHODS.analysisListRuns]: AuthOrchestrationReadScope,
  [WS_METHODS.analysisGetRun]: AuthOrchestrationReadScope,
